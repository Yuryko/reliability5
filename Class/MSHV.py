...
np.save('T.npy', T)
np.save('VBR.npy', VBR)
np.save('VBR_MAZH.npy', VBR_MAZH)
np.save('VBR_D.npy', VBR_D)
np.save('MCHV.npy', MCHV)
np.save('D_MCHV.npy', D_MCHV)
np.save('D_MCHV_MAZH.npy', D_MCHV_MAZH)
np.save('VBR_D_MAZH.npy', VBR_D_MAZH)

print np.load('T.npy')


            # return T, VBR, VBR_MAZH, VBR_D, MCHV, D_MCHV, D_MCHV_MAZH, VBR_D_MAZH
            # print ('Т'), T
            # print ('VBR'), VBR
            # print ('VBR_MAZH'), VBR_MAZH
            # print ('VBR_D'), VBR_D
            # print ('MCHV'), MCHV
            # print ('D_MCHV'), D_MCHV
            # print ('D_MCHV_MAZH'), D_MCHV_MAZH
            # print ('VBR_D_MAZH'), VBR_D_MAZH
