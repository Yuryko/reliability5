G_M16 = [M16*KM2[0], M16*KM2[1], M16*KM2[2], M16*KM2[3], M16*KM2[4], M16*KM2[5], M16*KM2[6], M16*KM2[7], M16*KM2[8], M16*KM2[9]]
G_R2 = [R2*KR[0], R2*KR[1], R2*KR[2], R2*KR[3], R2*KR[4], R2*KR[5], R2*KR[6], R2*KR[7], R2*KR[8], R2*KR[9]]
G_R3 = [R3*KR[0], R3*KR[1], R3*KR[2], R3*KR[3], R3*KR[4], R3*KR[5], R3*KR[6], R3*KR[7], R3*KR[8], R3*KR[9]]
G_R4 = [R4*KR[0], R4*KR[1], R4*KR[2], R4*KR[3], R4*KR[4], R4*KR[5], R4*KR[6], R4*KR[7], R4*KR[8], R4*KR[9]]
G_R5 = [R5*KR[0], R5*KR[1], R5*KR[2], R5*KR[3], R5*KR[4], R5*KR[5], R5*KR[6], R5*KR[7], R5*KR[8], R5*KR[9]]
G_R6 = [R6*KR[0], R6*KR[1], R6*KR[2], R6*KR[3], R6*KR[4], R6*KR[5], R6*KR[6], R6*KR[7], R6*KR[8], R6*KR[9]]
G_R7 = [R7*KR[0], R7*KR[1], R7*KR[2], R7*KR[3], R7*KR[4], R7*KR[5], R7*KR[6], R7*KR[7], R7*KR[8], R7*KR[9]]
...
G_RZ3 = [RZ3*KR[0], RZ3*KR[1], RZ3*KR[2], RZ3*KR[3], RZ3*KR[4], RZ2*KR[5], RZ2*KR[6], RZ2*KR[7], RZ2*KR[8], RZ3*KR[9]]
G_D4 = [D4*KD[0], D4*KD[1], D4*KD[2], D4*KD[3], D4*KD[4], D4*KD[5], D4*KD[6], D4*KD[7], D4*KD[8], D4*KD[9]]
G_T1 = [T1*KD[0], T1*KD[1], T1*KD[2], T1*KD[3], T1*KD[4], T1*KD[5], T1*KD[6], T1*KD[7], T1*KD[8], T1*KD[9]]
G_TR = [TR*KTR[0], TR*KTR[1], TR*KTR[2], TR*KTR[3], TR*KTR[4], TR*KTR[5], TR*KTR[6], TR*KTR[7], TR*KTR[8], TR*KTR[9]]

def sql_connection():
	try:
		con = sqlite3.connect('rea.db')
	except Error:
		print(Error)
	finally:
		con.close()
...
cur.executecur.execute("""CREATE TABLE IF NOT EXISTS elements(
   elemid INT PRIMARY KEY,25, 30, 35, 40, 45, 50, 55, 60, 65, 70
   f_r25 REAL,
   f_r30 REAL,
   f_r35 REAL,
   f_r40 REAL,
...
cur.execute("""INSERT INTO elements(elemid, f_r25, f_r30, f_r35, f_r40, 
f_r45, f_r50, f_r55, f_r60, f_r65, f_r70) 
   VALUES('00001', 'Alex', 'Smith', 'male');""")
   
cur.executecur.execute("""CREATE TABLE IF NOT EXISTS elem_info(
   elemid INT PRIMARY KEY,
   type TEXT,
   longname TEXT,
   name TEXT,
   TU TEXT);
...
for i in range(0, time):     # время до 90000 ч
    ...
    P_M16 = [np.exp(-G_M16[0]*t), np.exp(-G_M16[1]*t), np.exp(-G_M16[2]*t), np.exp(-G_M16[3]*t), np.exp(-G_M16[4]*t),
             np.exp(-G_M16[5]*t), np.exp(-G_M16[6]*t), np.exp(-G_M16[7]*t), np.exp(-G_M16[8]*t), np.exp(-G_M16[9]*t)]  # 4_1 шт
