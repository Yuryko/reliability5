...
# диоды
KD = [[25, 30, 35, 40, 45, 50, 55, 60, 65, 70],
      [0.1930, 0.2111, 0.2317, 0.2553, 0.2829, 0.3156, 0.3552, 0.40422, 0.4662, 0.5467] ]   # Коэфициент из српавочника, взяты для соотношения токов 0,6
...
# индикаторы
KI = [[25, 30, 35, 40, 45, 50, 55, 60, 65, 70],
      [0.033, 0.048, 0.068, 0.096, 0.135, 0.187, 0.257, 0.349, 0.47, 0.628] ] # Коэфициент из српавочника, взяты для соотношения токов 0,3

I1 = 0.18E-6        # 1  индикатор ИПД148В-Л	аА0.339.189ТУ
I2 = 0.21E-6        # 1  Индикатор ИПВ72А1-4/5х7К (красный)	АЕЯР.432220.232ТУ

# конденсаторы
KC = [[25, 30, 35, 40, 45, 50, 55, 60, 65, 70],
      [0.033, 0.048, 0.068, 0.096, 0.135, 0.187, 0.257, 0.349, 0.47, 0.628] ]
...
VBR_D = []          # ВБР модуля с мажорированием
VBR_MAZH = []       # ВБР модуля с дублированием и без мажорирования
