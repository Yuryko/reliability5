...
ax.plot(T, vbr, c=(0.25, 0.25, 1.00), lw=2, label="Blue signal", zorder=10)
ax.plot(T, vbr1, c=(1.00, 0.25, 0.25), lw=2, label="Red signal")
# ax.plot(X, Y3, linewidth=0,
#        marker='o', markerfacecolor='w', markeredgecolor='k')

ax.set_title('<- Надежность ->', fontsize=20, verticalalignment='bottom')
